...
public class EjercicioOIA {
	...
	public void leer(String path) {
		almacenamiento = LectorDeArchivo.leer(path);
	//	System.out.println(almacenamiento.getList());
	}
	...
	public void escribir(String path) {
		EscritorDeArchivo.escribir(path, almacenamiento.getCantAplicacionesABorrar());
	}
	...
	public void resolver() {
		almacenamiento.calcularAplicaciones();
	}
}
